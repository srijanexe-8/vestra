...
const templates = {
  shirt_default: require('../../assets/images/icon.png'),
  pants_default: require('../../assets/images/icon.png'),
  shoes_default: require('../../assets/images/icon.png'),
  accessory_default: require('../../assets/images/icon.png'),
};
...
export const TEMPLATE_MAP = {
  ...
  Accessories: {
    fallback: templates.accessory_default,
  },
};
